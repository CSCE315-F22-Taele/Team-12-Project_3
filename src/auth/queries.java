...
public class queries {
	...
	public static String addOrder(Order order) {
		return String.format(
				...
				order.getName(), order.getServerId(), order.getTimeOrdered(), order.isOrdered(), order.getPrice());
	}
	 ...
	 */
	public static String addUser(String username, UserType type) {
		return String.format(
				"INSERT INTO users (username, user_type) VALUES ('%s', (SELECT id FROM user_types WHERE type = '%s'))",
	...
	public static String addIngredientToInventory(String ingredientName, int quantity) {
		return String.format("INSERT INTO inventory (ingredient_name, quantity) VALUES ('%s', '%s')", ingredientName,
				quantity);
	}
	...
	public static String addIngredients(/*  */) {
		return String.format(
				"INSERT INTO ingredients (item_id, order_id, amount_per_order) VALUES ('%s', '%s', '%s', '%s', '%s')",
				null);
