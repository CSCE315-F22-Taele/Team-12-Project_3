...
export default function Cart({ serverId, menuItems }: thisProp) {
	...
	const tableColumns: GridColDef[] = [
		{ field: 'itemName', headerName: 'Item Name', type: 'string', width: 600 },
	...
	return (
		<>
			<ThemeProvider theme={StyledTheme}>
				...
				<Typography><h1>New Menu Item Addition</h1></Typography>
                ...
                <StyledDiv className="AddMenuItemName">
                    ...
                    <TextField
                        ...
                        helperText={(price <= 0 && !priceFirstPass)  ? "Please enter a positive number" : ""}
                        className="Quantity">    
                    </TextField>
                </StyledDiv>
